...
export default function PlaylistView() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-8 px-6 min-h-[70vh] flex flex-col">
      ...
      <div className="flex items-end gap-8 mb-10 pb-10">
        <div className="w-48 h-48 rounded-2xl overflow-hidden shadow-md relative group bg-[#1d1d1f] dark:bg-[#f5f5f7]">
          {songs.length > 0 && songs[0].al?.picUrl ? (
            ...
            <Heart className="absolute inset-0 m-auto text-white dark:text-black w-16 h-16" fill="currentColor" />
          )}
        </div>
        <div className="flex flex-col gap-3">
          <span className="text-xs font-semibold tracking-widest text-[#86868b] uppercase">Playlist</span>
          <h1 className="text-5xl font-bold tracking-tight text-[#1d1d1f] dark:text-[#f5f5f7]">
            我喜欢的音乐
          </h1>
          <div className="flex items-center gap-3 text-sm text-[#86868b] mt-2">
